...
const readUser = () => {
    ...
    xhttp.open('GET', 'https://koders1gpython-default-rtdb.firebaseio.com/zayra/users/.json')
    ...
    document.querySelectorAll(".btn__delete__user").forEach((btn) => {
        ...
        btn.addEventListener('click', function (user) {
            ...
            if (user.target.classList.contains('btn__delete__user')) {
                ...
                // request
                requestAjax(
                    `https://koders1gpython-default-rtdb.firebaseio.com/zayra/users/${idUser}.json`,
                    redirectToUsers,
                    'DELETE'
                )
            }
        ...
        usersList += `
            <li class="d-flex px-3 py-2 shadow-sm mb-2 rounded justify-content-between item__user"> 
                ...
                <div class="d-flex"> 
                    ...
                    <a href="update-user.html?id=${user}" class="btn btn-link">Actualizar usuario</a> 
