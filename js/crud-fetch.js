...
const deleteUser = (idUser) => {
    fetch(`https://koders1gpython-default-rtdb.firebaseio.com/zayra/users/${idUser}.json`, {
        method: 'DELETE'
    })
        .then(response => {
...
const readUsers = () => {
    ...
    fetch(`https://koders1gpython-default-rtdb.firebaseio.com/zayra/users/.json`, options)
        .then(response => {
            return response.json()
        })
        .then((users) => {
...
fetch(`https://koders1gpython-default-rtdb.firebaseio.com/zayra/users/-MQngx3MO3DyNSWX-Soa.json`, {
    method: 'DELETE'
})
    .then(response => {
        return response.json()
